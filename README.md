...
### SEO Configuration
```html
<title>Travis Duncan | Information Systems Security Manager</title>
<meta name="description" content="Travis Duncan - Information Systems Security Manager specializing in cybersecurity, compliance automation, and risk management">
<meta name="keywords" content="GRC Engineer, Cybersecurity, AWS Security, Information Systems Security Manager, Compliance, Risk Management, CISSP, CCSP">
```
